...
def simulation(pt_mean,
    ...
    for i in range(nb_data):
        ...
        nb_m=np.random.randint(nb_m_range[0],nb_m_range[1]) if type(nb_m_range) is list else nb_m_range
        nb_t=np.random.randint(nb_t_range[0],nb_t_range[1]) if type(nb_t_range) is list else nb_t_range
